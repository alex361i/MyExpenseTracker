...
public class MainActivity extends AppCompatActivity {
    public static final String PACKAGE_NAME = "advanced.dtu.dk.expensetracker";
   ...
   private int permissionCheck = ContextCompat.checkSelfPermission(this,
    ...
    public final static int MY_PERMISSIONS_REQUEST_ACCESS_CAMERA = 1;
    ...
    //handle the request permissions request response
    @Override
